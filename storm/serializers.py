...
class StormDataSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = StormData
        fields = ('storm_advisory', 'windrisk', 'surgerisk', 'maxflood', 'maxwind', 'landfall_location', 'landfall_datetime',
    ...
    #         wind_date = " ".join(data['advisory_wind_date'].split(" on "))
    ...
    #         data['next_advisory_wind_date'] = next_wind_advdate.strftime('%I%p CDT %a %b %d %Y')

    #     if data['advisory_flood_date']:
    #         flood_date = " ".join(data['advisory_flood_date'].split(" on "))
    ...
    #         data['next_advisory_flood_date'] = next_flood_advdate.strftime('%I%p CDT %a %b %d %Y')
    #     return data
