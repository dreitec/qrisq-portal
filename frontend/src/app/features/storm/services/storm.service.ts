        ...
        .subscribe((result) => {
          if (!result || (Object.keys(result.storm).length < 1)) {
            const stormData: StormData = {
              ...
              advisoryDate: '',
              issuedDate: '',
              stormAdvisoryLatitude: 0,
              stormAdvisoryLongitude: 0,
              stormAdvisoryDirection: '',
              stormAdvisorySpeed: 0,
              stormAdvisoryWind: 0,
              stormAdvisoryPressure: 0,
              floodAdvisoryDate: '',
              windAdvisoryDate: '',
          ...
          const stormData: StormData = {
            ...
            maxWind: Number.parseFloat(result.storm.maxwind),
            forecastAdvisory: 0,
            advisoryDate: result.storm.advisory_date,
            issuedDate: result.storm.storm_advisory.issued_datetime,
            stormAdvisoryLatitude: result.storm.storm_advisory.latitude,
            stormAdvisoryLongitude: result.storm.storm_advisory.longitude,
            stormAdvisoryDirection: result.storm.storm_advisory.direction,
            stormAdvisorySpeed: result.storm.storm_advisory.speed,
            stormAdvisoryWind: result.storm.storm_advisory.wind,
            stormAdvisoryPressure: result.storm.storm_advisory.pressure,
